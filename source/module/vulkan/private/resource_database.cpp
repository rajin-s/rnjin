...
{
    resource_database::resource_database( renderer_internal& parent ) : parent( parent ) {}
    resource_database::~resource_database() {}

    const resource_database::meshes::entry resource_database::meshes::get( const resource::id resource_id ) const
    {
        static const resource_database::meshes::entry invalid_entry( vk::Buffer(), vk::DeviceMemory() );
