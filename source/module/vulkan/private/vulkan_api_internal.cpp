...
{
    void api_internal::initialize( const string& application_name )
    {
        initialize_instance( application_name );
        initialize_validation();
    }
    void api_internal::clean_up()
    {
        clean_up_validation();
        clean_up_instance();
    }

    void api_internal::initialize_instance( const string& application_name )
    {
    ...
    void api_internal::clean_up_instance()
    {
    ...
    void api_internal::initialize_validation()
    {
    ...
    void api_internal::clean_up_validation()
    {
    ...
    const vk::DebugUtilsMessengerCreateInfoEXT api_internal::get_debug_messenger_create_info()
    {
        ...
        return vk::DebugUtilsMessengerCreateInfoEXT(
            ...
            &api_internal::debug_callback, // pfnUserCallback
            (void*) this                       // pUserData
        );
    }
    ...
    VKAPI_ATTR VkBool32 VKAPI_CALL api_internal::debug_callback( VkDebugUtilsMessageSeverityFlagBitsEXT severity, VkDebugUtilsMessageTypeFlagsEXT type, const VkDebugUtilsMessengerCallbackDataEXT* callback_data, void* user_data )
    {
        api_internal* self = (api_internal*) user_data;
