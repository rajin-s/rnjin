...
namespace rnjin
{
    ...
    {
        /***************************************
         * High-level initialization / cleanup *
         ***************************************/
        renderer<vulkan>::internal::internal( vulkan& api ) : api( api )
        {
            vulkan_log_verbose.print( "Created Vulkan renderer internals" );
        }
        renderer<vulkan>::internal::~internal()
        {
            vulkan_log_verbose.print( "Destroyed Vulkan renderer internals" );
        }

        void renderer<vulkan>::internal::initialize()
        {
        ...
        void renderer<vulkan>::internal::clean_up()
        {
         ...
         * Rendering *
         *************/
        void renderer<vulkan>::internal::render( const render_view& view )
        {
        ...
        void renderer<vulkan>::internal::add_window_target( window<GLFW>& target )
        {
        ...
        void renderer<vulkan>::internal::create_device( const vk::SurfaceKHR* reference_surface )
        {
            ...
            let require_validation = api._internal->validation.any_enabled();
        ...
        void renderer<vulkan>::internal::destroy_device()
        {
        ...
        void renderer<vulkan>::internal::device_info::find_queue_family_indices( const vk::SurfaceKHR* surface )
        {
